                                ...
                                <div class="ach-menu">
                                    @php
                                        $sub = function($category) {
                                            ...
                                            .'<div onclick="filter(\'all\')">Everything</div>'
                                        ...
                                        <div class="faq-content">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    - Gold achievement adds 10% experienceа.<br>
                                                ...
                                                <li>
                                                    ...
                                                    - Every 10 Usdles increase your experience by 10%.
                                                    @if($user->level < 3)
                                                    <br>
               ...
               <div class="user_tab" id="ref">
                    <div class="col-xs-12 col-sm-12 col-md-9">
                        ...
                        <div class="ref-content">
                            ...
                            Each person who registers using your referral code will receive {{$settings->promo_sum}} USD

                            <br><br>
                            As a reward for each <span class="ref_bb">active referral</span> <i class="fas fa-question-circle fqc tooltip" title="An active referral is the one whose total winnings of all games have reached 50 USD"></i> You are getting {{$settings->promo_sum}} USD,<br>
...
<div class="fn_form_block">
			...
			<br><br>
			 <div class="ref-header">Safety</div>
			 <div class="ref-content">
