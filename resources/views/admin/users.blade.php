<div id="__ajax_title" style="display: none">Users</div>
                ...
                <table class="kt-datatable__table" style="display: block;">
                    <thead class="kt-datatable__head">
                        <tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 181px;">Balance</span></th>
...
<script type="text/javascript" src="/admin_assets/js/pages/users.js"></script>
