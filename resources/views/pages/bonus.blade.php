@if(Auth::guest()) <script type="text/javascript">load('/', function() { $('.md-auth').toggleClass('md-show', true); });</script> @else
<div class="bonus_page_wrapper">
    <div class="bonus_page_header">Special offers and bonuses.</div>
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="$('#wheel').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name">Wheel</div>
                <div class="bonus_option_description">Spin the free wheel with a bonus<br>every day</div>
                <div class="bonus_option_button">Open</div>
            </div>
        </div>
        <div class="bonus_option" onclick="$('#ref').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name">Affiliate program</div>
                <div class="bonus_option_description">Get free bonus<br>for every 10 referrals!</div>
                <div class="bonus_ref_option_counter"><span class="ref_reload_text">0/10</span>&nbsp;referrals</div>
                <div class="bonus_option_button">More</div>
            </div>
        </div>

        @if(strpos(Auth::user()->login, 'id') !== false)
            <div class="bonus_option" onclick="window.open('https://t.me/gambel_support')">
                @if(\App\User::isSubscribed(Auth::user()->login2))
                    <div class="bonus_option_ok">
                        <i class="fal fa-check"></i>
                        <span>You have completed this task.</span>
                    </div>
                @endif
                <div class="bonus_option_content">
                    <div class="bonus_option_image bonus_option_vk"><i class="fab fa-telegram"></i></div>
                    <div class="bonus_option_name">telegram community</div>
                    <div class="bonus_option_description">Join the VKontakte group and get 0.45 &nbsp;<i class="fad fa-coins"></i> on account!</div>
                    <div class="bonus_option_button">Go</div>
                </div>
            </div>
        @endif
        <div id="notificationOption" style="display: none" class="bonus_option">
            ...
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name">Notifications</div>
                <div class="bonus_option_description">Subscribe to notifications with promotional codes and news and get 1 &nbsp;<i class="fad fa-coins"></i> on account!</div>
                <div class="bonus_option_button">Subscribe</div>
            </div>
        </div>
    </div>
    <div class="bonus_page_header">Events</div>
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="window.open('https://t.me/gambel_support')">
            <div class="bonus_option_content">
                <div class="bonus_option_image bonus_option_vk_m"><i class="fal fa-handshake"></i></div>
                <div class="bonus_option_name" style="width: 75%;">Cooperation</div>
                <div class="bonus_option_description" style="margin-bottom: 64px;">if you own a telegram channel +10 k real members or a youtube channel +26k we ask you to contact us for a colaborate with us and get alot of surprises for you and your followers . contact us on telegram to get fast respond </div>
                <div class="bonus_option_button">Telegram Support</div>
            </div>
        </div>
        <div class="bonus_option" onclick="$('#rain').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                <div class="bonus_option_image bonus_option_rain">
                    <img src="/img/game/svg/clouds.svg" alt="">
                </div>
                <div class="bonus_option_name">Rain</div>
                <div class="bonus_option_description">
                    Every few hours<br>an event occurs in the chat,<br>distributing bonus<br>random people.
                </div>
                <div class="bonus_option_button">More</div>
            </div>
        </div>
        <div class="bonus_option" onclick="$('.md-promo').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name">Promo code</div>
                <div class="bonus_option_description">Enter a promo code or referral code and get a bonus to your account!</div>
                <div class="bonus_option_button">Enter</div>
            </div>
        </div>
    </div>
</div>
