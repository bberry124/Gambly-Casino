    ...
    <div class="md-modal md-email-activation md-s-height md-show md-effect-1">
        <div class="md-content">
            ...
            <div class="email-container">
                ...
                <div>На {{Auth::user()->email}} An email has been sent with a link to verify your account.</div>
				<br>
                        ...
                        <div class="payment-total__first-row">
                            <div class="payment-field payment-sum">
                                ...
                                <div class="validation-wrapper">
                                    <span class="validation-message"></span>
                                    <div class="wallet-input-wrapper">
                                        <input inputmode="numeric" value="{{$settings->min_with}}" type="text" name="amount" id="withv" data-what="Amount" placeholder="Withdrawal amount" data-min="{{$settings->min_with}}" data-max="15000" data-value-on-nonnumeric="1000" class="numeric-input-validate game-sidebar__input game-sidebar__input_dark" autocomplete="off">
                                        <div class="wallet-input-currency">Usd.</div>
                                    </div>
                                </div>
                            </div>
