<div class="game__wrapper">
    <div class="col-md-3 col-sm-12 g_sidebar" data-parent="#w_container">
        <div class="row g_follow">
			...
			<?php echo $__env->make('pages.game_task', ['game_id' => 5], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
	...
	<div class="outcome-window outcome-window_won outcome-window_centered">
        ...
        <div class="cf_info cf_info_m">
            ...
            <div class="mines_grid">
                <?php for($i = 0; $i < 5 * 5; $i++): ?>
                    <div data-grid-id="<?php echo e($i); ?>" class="mine_disabled"></div>
                <?php endfor; ?>
            </div>
...
<?php /**PATH D:\xampp\htdocs\Gambly\resources\views/pages/mines.blade.php ENDPATH**/ ?>